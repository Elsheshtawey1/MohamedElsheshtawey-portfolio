...
const About = ({ data }: AboutProps) => {
  const stats = [
    { icon: Code2, label: "Years Experience", value: "8+", color: "from-blue-500 to-cyan-500" },
    { icon: Target, label: "Projects Completed", value: "50+", color: "from-emerald-500 to-teal-500" },
      ...
      <div className="max-w-7xl mx-auto">
        ...
        >
          ...
          <m.h2 
            ...
            className="text-5xl md:text-6xl font-bold text-primary mb-6 gradient-text"
          >
          ...
          <m.div 
            ...
            className="w-32 h-1 bg-gradient-primary mx-auto rounded-full shadow-glow" 
          />
        </m.div>
              ...
              <div className="flex items-start gap-4">
                ...
                <div>
                  ...
                  <p className="text-secondary leading-relaxed">
                    I'm driven by the challenge of creating exceptional digital experiences that make a real impact. 
                    Every project is an opportunity to push boundaries and deliver solutions that exceed expectations.
                  </p>
                </div>
              </div>
            </Card>
