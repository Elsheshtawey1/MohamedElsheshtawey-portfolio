          ...
          <div className="space-y-6">
            ...
            <div className="flex flex-col sm:flex-row gap-4 pt-4">
              {project.details.links.live && (
                <Button size="lg" className="bg-gradient-primary hover:shadow-glow transition-smooth" onClick={() => window.open(project.details.links.live, "_blank")}>
              ...
              {project.details.links.github && (
                <Button variant="outline" size="lg" className="border-primary/30 text-primary hover:bg-primary/10" onClick={() => window.open(project.details.links.github, "_blank")}>
                    ...
                    <div key={category}>
                      ...
                      <div className="flex flex-wrap gap-1">
                        {techs.map((tech, index) => (
                          <Badge key={index} variant="secondary" className="text-xs bg-primary/5 text-secondary border-primary/10">
                            {tech}
                          </Badge>
                        ))}
                      </div>
